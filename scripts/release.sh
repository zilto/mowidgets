#!/bin/bash
# adapted from https://github.com/marimo-team/marimo/blob/a255d5a33d9052bd1b8700a2448134bf3ebc127d/scripts/release.sh
...
echo "  1. Monitor the release: https://github.com/zilto/mowidgets/actions/workflows/release.yaml"
echo "  2. Draft the release notes: https://github.com/zilto/mowidgets/releases/new?tag=$NEW_VERSION"